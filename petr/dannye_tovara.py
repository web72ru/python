...
def получаем_данные_товара(список_ссылок):
    ...
    for ссылка in список_ссылок:
        ...
        значение_описания = [словарь['data']['product']['description']]

        ключи.append(ключ_название)
        ключи.append(ключи_категории)
        ключи.append(ключ_описание)
        ключи.append(ключи_характеристик_список)
        ключи.append(ключи_изображений)

        значения.append(значение_название)
        значения.append(значения_категории)
        значения.append(значение_описания)
        значения.append(значения_характеристик_список)
        значения.append(изображения)
