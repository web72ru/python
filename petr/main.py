...
главные_категории = ['https://petrovich.ru/catalog/1520/']
'''
...
for главная_ссылка in главные_категории:
    ...
    икспас = lxml.html.document_fromstring(страница.text)
    товаров_на_странице = икспас.xpath('//p[@data-test="products-counter"]/text()[2]')
    пагинация = int(товаров_на_странице[0]) // 20
    for ч in range(0, пагинация):
        главная_с_пагинацией = главная_ссылка + '?p=' + str(ч)
        главные_категории_с_пагинацией.append(главная_с_пагинацией)

print(главные_категории_с_пагинацией)
